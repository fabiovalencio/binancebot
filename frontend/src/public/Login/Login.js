              ...
              <div className="col-12 d-flex align-items-center justify-content-center">
                  <div className="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                      ...
                      <form action="#" className="mt-4" onSubmit={onSubmit}>
                          ...
                          <div className="form-group mb-4">
                              ...
                              <div className="input-group">
                                  ...
                                  <input type="email" className="form-control" placeholder="example@company.com" id="email" autoFocus required onChange={setEmail} />
                              </div>  
                          </div>
                          ...
                          <div className="form-group">
                              ...
                              <div className="form-group mb-4">
                                  ...
                                  <div className="input-group">
                                      ...
                                      <input type="password" placeholder="Password" className="form-control" id="password" required onChange={setPassword} />
                                  </div>  
                              </div>
                      ...
                      <div className="d-flex justify-content-center my-4">
                          <Link to="#" className="btn btn-icon-only btn-pill btn-outline-gray-500 me-2" aria-label="facebook button" title="facebook button">
                          ...
                          <Link to="#" className="btn btn-icon-only btn-pill btn-outline-gray-500 me-2" aria-label="twitter button" title="twitter button">
                          ...
                          <Link to="#" className="btn btn-icon-only btn-pill btn-outline-gray-500" aria-label="github button" title="github button">
